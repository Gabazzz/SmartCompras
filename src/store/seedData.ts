...
export const COMPRAS_JULHO: Compra[] = [
  ...
  { id: 'jul-23', produto: 'Achocolatado em pó Nescau sachê 730g', categoria: 'Alimentação', essencial: false, quantidade: 1, unidade: 'un', valorUni: 24.29, valorTotal: 24.29, mercado: mercadoJulho, data: dataJulho },
  ...
  { id: 'jul-27', produto: 'Biscoito manteiga Marilan 300g chocolate', categoria: 'Alimentação', essencial: false, quantidade: 1, unidade: 'un', valorUni: 6.48, valorTotal: 6.48, mercado: mercadoJulho, data: dataJulho },
  { id: 'jul-28', produto: 'Mistura para bolo Dona Benta 450g chocolate/avelã', categoria: 'Alimentação', essencial: false, quantidade: 1, unidade: 'un', valorUni: 8.68, valorTotal: 8.68, mercado: mercadoJulho, data: dataJulho },
  { id: 'jul-29', produto: 'Milho para pipoca Yoki 400g', categoria: 'Alimentação', essencial: false, quantidade: 1, unidade: 'un', valorUni: 5.46, valorTotal: 5.46, mercado: mercadoJulho, data: dataJulho },
  ...
  { id: 'jul-36', produto: 'Refrigerante CR Naville 200g trad.', categoria: 'Alimentação', essencial: false, quantidade: 4, unidade: 'un', valorUni: 6.90, valorTotal: 27.60, mercado: mercadoJulho, data: dataJulho },
